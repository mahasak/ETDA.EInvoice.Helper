    ...
    public class InvoiceXmlGenerator
    {
        ...
        public void Init(DataTable Buyer, DataTable Seller, DataTable Reference, DataTable Item, string InvoiceId, string path)
        {
            ...
            try
            {
                ...
                string seller_phoneno = ReportHelper.getFullThaiMobilePhone(seller.Rows[0]["phone_no"].ToString(), seller.Rows[0]["phone_ext"].ToString());
                ...
                string buyer_phoneno = ReportHelper.getFullThaiMobilePhone(buyer.Rows[0]["phone_no"].ToString(), buyer.Rows[0]["phone_ext"].ToString());
